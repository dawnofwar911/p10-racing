                ...
                <tr className="bg-black bg-opacity-20 border-0">
                  <td colSpan={4} className="p-0 border-0">
                    <div className="p-3 p-md-4 rounded-0 border-bottom border-secondary border-opacity-25 shadow-inner" style={{ backgroundColor: 'rgba(21, 21, 30, 0.6)' }}>
                      {entry.breakdown && (
                        <div className="row g-3 g-md-4 mb-4 border-bottom border-secondary border-opacity-10 pb-4">
                          <div className="col-12 col-md-6 border-md-end border-secondary border-opacity-10">
                            ...
                            <div className="d-flex flex-wrap justify-content-between align-items-start gap-2">
                              <div className="d-flex align-items-center">
                                ...
                                <div>
                                  <span className="fw-bold fs-5 text-uppercase letter-spacing-1 d-block text-white text-break">{entry.breakdown?.p10Driver.replace(/_/g, ' ')}</span>
                          ...
                          <div className="col-12 col-md-6 ps-md-4">
                            ...
                            <div className="d-flex flex-wrap justify-content-between align-items-start gap-2">
                              <div className="d-flex align-items-center">
                                ...
                                <div>
                                  <span className="fw-bold fs-5 text-uppercase letter-spacing-1 d-block text-white text-break">{entry.breakdown?.dnfDriver.replace(/_/g, ' ')}</span>
