...
function PredictPage() {
  ...
  const summaryView = (
    <Container className="mt-4 mb-4">
      ...
      <div className="text-center mt-3">
        <Card className={`p-4 border-${isLocked ? 'danger' : 'success'} bg-dark mb-4 shadow-sm mx-auto`} style={{ maxWidth: '600px' }}>
  ...
  return (
    <>
      ...
      >
        <div className="mt-3 flex-grow-1 d-flex flex-column pb-5 mb-5">
          ...
          {activeTab === 'p10' && (
            <div className="mx-auto w-100" style={{ maxWidth: '500px' }}>
              ...
              <div className="driver-list-scroll px-1 pb-5" style={{ maxHeight: '65vh', overflowY: 'auto', overscrollBehavior: 'contain' }}>
                {drivers.map((driver) => (
